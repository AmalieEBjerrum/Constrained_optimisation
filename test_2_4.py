...
def solve_with_osqp_and_track(H, g, C_ineq, d_ineq):
    P = sparse.csc_matrix(H)
    q = g
    A = sparse.csc_matrix(C_ineq)
    ...
    x_opt = res.x
    history = prob._model.solve_history  # Not documented, but possible to access
    return x_opt, res.info.iter, res, history
...
x_opt, num_iterations, result, history = solve_with_osqp_and_track(H, g, C_ineq, d_ineq)
